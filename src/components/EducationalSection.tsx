...
export const EducationalSection = ({ ammType, lastSwapResult, swapDirection, tokenA, tokenB }: EducationalSectionProps) => {
  ...
  return (
    <section className="bg-[#13111C] text-white/90 p-8 md:p-12 rounded-3xl border border-white/5 shadow-2xl space-y-12">
      ...
      <AnimatePresence mode="wait">
        {lastSwapResult && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="grid grid-cols-1 md:grid-cols-4 gap-6 bg-white/[0.04] p-8 rounded-2xl border border-white/10 backdrop-blur-sm"
          >
            <div className="space-y-2">
              <div className="text-[10px] font-bold text-white/50 uppercase tracking-[0.2em]">Realized Output</div>
              <div className="text-xl font-bold text-white/90 flex items-center truncate">
            ...
            <div className="space-y-2">
              <div className="text-[10px] font-bold text-white/50 uppercase tracking-[0.2em]">Price Impact</div>
              <div className={cn("text-xl font-bold", lastSwapResult.priceImpact > 5 ? "text-red-400" : "text-green-500")}>
            ...
            <div className="space-y-2">
              <div className="text-[10px] font-bold text-white/50 uppercase tracking-[0.2em]">LP Fee (0.3%)</div>
            ...
            <div className="space-y-2">
              <div className="text-[10px] font-bold text-white/50 uppercase tracking-[0.2em]">Invariant Shift ({lastSwapResult.invariantName})</div>
              ...
              <p className="text-[10px] text-green-500 font-medium">↑ Improved via fee accumulation</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 bg-white/[0.04] p-8 rounded-2xl border border-white/10">
        <div className="space-y-4">
          <div className="flex items-center gap-2 text-purple-400 font-bold uppercase text-xs tracking-[0.2em]">
            Key Advantage
          </div>
          <p className="text-white/50 text-lg leading-relaxed">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-white/[0.04] border border-white/10 p-6 rounded-2xl hover:bg-white/10 transition-colors group">
          <h4 className="text-lg font-bold mb-2 text-white/90">Can we control slippage?</h4>
        ...
        <div className="bg-white/[0.04] border border-white/10 p-6 rounded-2xl hover:bg-white/10 transition-colors group">
          <h4 className="text-lg font-bold mb-2 text-white/90">Are LP fees constant?</h4>
          <p className="text-white/50 text-sm leading-relaxed">
        ...
        <div className="bg-white/[0.04] border border-white/10 p-6 rounded-2xl hover:bg-white/10 transition-colors group">
          <h4 className="text-lg font-bold mb-2 text-white/90">Can the pool be drained?</h4>
          <p className="text-white/50 text-sm leading-relaxed">
